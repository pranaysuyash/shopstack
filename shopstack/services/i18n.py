...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "tour.step2.body": "Open Shopping to compare stores and prices before you leave home.",
        "tour.step3.title": "Shop & reconcile",
        "tour.step3.body": "Use Shopping in-store. Pantry when you get back.",
        ...
        "help.lot_id.title": "Batch",
        "help.lot_id.body": "A unique reference for each batch of an item you buy. Multiple batches of the same item (e.g. two milk packs) each have their own expiry.",
        "help.batch_syntax.title": "Batch syntax",
        "help.batch_syntax.body": "One line per item, with optional quantity. Separate batch references with a colon, e.g. inv-001: 3.",
        ...
        "help.scene_type.title": "Image type",
        ...
        "help.federation_share.title": "Share file",
        ...
        "help.sms_phone_registry.title": "Phone numbers",
        ...
        "help.trace_retention.title": "Action history retention",
        "help.trace_retention.body": "How long we keep the action log (add, consume, move, scan, parse). Default 30 days. Shorter is more private; longer helps diagnostics.",
        ...
        "help.global_search.body": "Search inventory, lists, recipes, and activity from one box. Press Enter to jump to the first result.",
        ...
        "privacy.sms_retention": "Phone numbers",
    ...
    "hi": {
        ...
        "tour.step2.body": "शॉपिंग खोलें — स्टोर और कीमत घर से निकलने से पहले देखें।",
        "tour.step3.title": "खरीदारी और रिकॉन्साइल",
        "tour.step3.body": "दुकान में शॉपिंग का उपयोग करें। घर आकर पैंट्री में रिकॉन्साइल करें।",
        ...
        # Inline help / tooltips (used by shopstack.services.tooltips)
        "help.lot_id.title": "बैच",
        "help.lot_id.body": "हर खरीदी गई बैच के लिए एक यूनिक रेफरेंस। एक ही आइटम के कई बैच (जैसे दूध के दो पैकेट) के अपने-अपने एक्सपायरी होते हैं।",
        "help.batch_syntax.title": "बैच सिंटैक्स",
        "help.batch_syntax.body": "हर आइटम एक लाइन में। बैच रेफरेंस के साथ मात्रा: inv-001: 3।",
        ...
        "help.scene_type.title": "इमेज टाइप",
        ...
        "help.federation_share.title": "शेयर फ़ाइल",
        ...
        "help.trace_retention.title": "एक्शन हिस्ट्री रिटेंशन",
        ...
        "help.global_search.body": "इन्वेंटरी, लिस्ट, रेसिपी, एक्शन — एक बॉक्स से।",
